...
if (isset($_SESSION['uid'])) {
    ...
    $sqll=" select count(booking.tid) as total_rooms from tenant,booking where tenant.tid=booking.tid and temail='$email'";
...
<body>
    <div id="user-profiles">
        ...
        <a href="rentedRoom.php"><div id="roomrented">
            <?php if(isset($row4['total_rooms']))echo $row4['total_rooms'];
            ?>
