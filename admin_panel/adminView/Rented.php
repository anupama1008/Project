...
<body>
  ...
  include "../config/conn.php";
    ...
    echo "</tr>";
    echo "<tr>";
    echo " <td><i class='fa fa-home'></i>  </td> <td class='room-type-cell'>" . "Room Type: " . $rows['type'] . "<br> Location: " . $rows['location'] . "</td>";
    echo "<td>" . "<a href='../enquire.php?rid=" . $rid . "'><Button>Details</Button></a>
