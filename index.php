...
<body>
  <div id="main-content">
    ...
    <div class="samples">
      <div class="sample1">
        ...
        <div id="part-2">
          ...
          <form action="Search.php" method="post" name="myform" onsubmit="return validateform()">
            <div class="sub_main">
                   <div id="search-cetagories">
                          <select name="selected" class="final" >
                          <?php 
                            include 'Conn.php';
                            $s="select distinct type from rooms";
                            $e=mysqli_query($conn,$s);
                            if($e){
                             while( $t=mysqli_fetch_assoc($e)){
                              ?>
                            <option value="<?php echo $t['type'] ?>"><p><?php echo $t['type'] ?></p> </option>
                            <?php 
                          }                              
                        }
                        ?>
             ...
             <div class="sel-btn">
             <input type="submit" name="homebtn" class="button" value="SEARCH">
    ...
    <div>
      <a href="AddLandlord.php"><button type="submit" class="btn">Add a Room</button></a>
    </div>
  </div>
</div>
 </div>
